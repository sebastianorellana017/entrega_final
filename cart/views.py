...
from .models import ColourVariation, Product, OrderItem, Address, Payment, Order, Category
...
from .serializers import ColourVariationSerializer, OrderItemSerializer, OrderSerializer, PaymentSerializer, ProductSerializer
...
class ProductListView(generic.ListView):
    ...
    def get_queryset(self):
        ...
        if categoria:
            qs = qs.filter(Q(categoria__name=categoria))
        return qs
...
class PaymentView(generic.TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["PAYPAL_SANDBOX_CLIENTE_ID"] = settings.PAYPAL_SANDBOX_CLIENTE_ID
        context['order'] = get_or_set_order_session(self.request)
